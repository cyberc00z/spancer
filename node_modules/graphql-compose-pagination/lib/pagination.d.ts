...
export declare function preparePaginationResolver<TSource, TContext>(tc: ObjectTypeComposer<TSource, TContext>, opts: PaginationResolverOpts): Resolver<TSource, TContext, PaginationTArgs>;
