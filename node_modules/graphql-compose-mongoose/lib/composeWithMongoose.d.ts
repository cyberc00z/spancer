...
export declare function composeWithMongoose<TDoc extends Document, TContext = any>(model: Model<TDoc>, opts?: ComposeWithMongooseOpts<TContext>): ObjectTypeComposer<TDoc, TContext>;
