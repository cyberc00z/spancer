...
function _toMongoDottedObject(obj, aliases, target = {}, prefix = '', collapseArray = false) {
    if ((!graphql_compose_1.isObject(obj) && !Array.isArray(obj)) || isPrimitive(obj)) {
        if (prefix)
            target[prefix] = obj;
        return obj;
    }
    ...
    objKeys.forEach((key) => {
        ...
        if (aliases && (aliases === null || aliases === void 0 ? void 0 : aliases[key])) {
            ...
            else if (graphql_compose_1.isObject(alias)) {
        ...
        if (key.startsWith('$')) {
            ...
            _toMongoDottedObject(obj[key], graphql_compose_1.isObject(subAliases) ? subAliases : undefined, target, Array.isArray(obj) && collapseArray ? prefix : newKey, collapseArray);
        }
        else {
