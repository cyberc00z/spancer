...
export declare function updateById<TSource = any, TContext = any, TDoc extends Document = any>(model: Model<TDoc>, tc: ObjectTypeComposer<TDoc, TContext>, opts?: UpdateByIdResolverOpts): Resolver<TSource, TContext, TArgs, TDoc>;
export {};
