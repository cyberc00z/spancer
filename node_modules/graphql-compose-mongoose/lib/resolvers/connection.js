...
function connection(model, tc, opts) {
    ...
    const _a = opts || {}, { findManyOpts, countOpts } = _a, restOpts = __rest(_a, ["findManyOpts", "countOpts"]);
    return graphql_compose_connection_1.prepareConnectionResolver(tc, Object.assign({ findManyResolver: findMany_1.findMany(model, tc, findManyOpts), countResolver: count_1.count(model, tc, countOpts), sort: sortConfigs }, restOpts));
}
