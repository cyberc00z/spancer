...
function removeById(model, tc, opts) {
    ...
    const resolver = tc.schemaComposer.createResolver({
        ...
        type: outputType,
        args: {
            _id: tc.hasField('_id') ? graphql_compose_1.toInputType(tc.getFieldTC('_id')).NonNull : 'MongoID!',
        },
