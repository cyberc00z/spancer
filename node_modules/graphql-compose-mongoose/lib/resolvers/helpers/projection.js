...
function dotifyRecurse(obj, res, aliases, prefix) {
    Object.keys(obj).forEach((key) => {
        ...
        else if (graphql_compose_1.isObject(value) && Object.keys(value).length > 0) {
            let subAliases;
            if (aliases && graphql_compose_1.isObject(aliases === null || aliases === void 0 ? void 0 : aliases[key])) {
