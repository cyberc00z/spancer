...
export declare function filterHelperArgs<TDoc extends Document = any>(typeComposer: ObjectTypeComposer<TDoc, any>, model: Model<TDoc>, opts?: FilterHelperArgsOpts): ObjectTypeComposerArgumentConfigMap<{
    filter: any;
}>;
