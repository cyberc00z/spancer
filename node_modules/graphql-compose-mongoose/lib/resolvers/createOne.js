...
function createOne(model, tc, opts) {
    ...
    const resolver = tc.schemaComposer.createResolver({
        ...
        type: outputType,
        args: Object.assign({}, helpers_1.recordHelperArgs(tc, Object.assign({ prefix: 'CreateOne', suffix: `${(opts === null || opts === void 0 ? void 0 : opts.suffix) || ''}Input`, removeFields: ['id', '_id'], isRequired: true, requiredFields }, opts === null || opts === void 0 ? void 0 : opts.record))),
